...
<head>
	<title>www.smpn8pdg.ac.id </title>
	<!-- Meta tag Keywords -->
					...
					<div class="col-xl-6 col-lg-5 top-social-w3pvt-am mt-lg-1 mb-md-0 mb-1 text-lg-left text-center">
						<div class="row">
							...
							<div class="col-xl-8 col-10 header-top_w3layouts text-md-right">
								<p class="text-bl">
									<span style="font-family:Times New Roman">Welcome To Portal PSB Online SMP N 8 PADANG: <?= $_SESSION['nm'] ?></span> <!-- nm dalam ['nm'] adalah nama variabel dari proseslogin -->
								</p>
							</div>
...
?>
	...
	<div class="copyright-w3ls py-4">
		<div class="container">
			<div class="row">
				<!-- copyright -->
				<p class="col-lg-8 copy-right-grids text-bl text-lg-left text-center mt-lg-2">© 2019 
					<a href="https://w3layouts.com/" target="_blank" class="text-colors">retno setianto</a>
				</p>
				<!-- //copyright -->
				<!-- social icons -->
