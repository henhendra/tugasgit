...
<div col-sm-6 row-sm-4 align="center">
    ...
    <h5>Jl.Dr Sutomo No.146 C,Marapalam,Kota Padang,Sumatera Barat</h5>
</div>
<hr>
...
<table border="0" align="right">
        <tr>
                <td colspan="2" align="center"><b>Padang
                 <?php echo TanggalIndo (date('Y-m-d')); ?></b><br><b>Direktur</b><br><br><br><hr><b></b>Ferry Ahmad Effendy S.Kom, M.Kom</br></td>
